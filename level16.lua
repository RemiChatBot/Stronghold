...
t.affichagecarte=function(pole)
	if donneecharger[56]==0 then
		donneecharger[56]=1
		map56sheethg=graphics.newImageSheet( "notgoh/carte/level14/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map56sheethd=graphics.newImageSheet( "notgoh/carte/level14/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map56sheetbg=graphics.newImageSheet( "notgoh/carte/level14/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map56sheetbd=graphics.newImageSheet( "notgoh/carte/level14/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map56sheeto1=graphics.newImageSheet( "notgoh/carte/level14/ah.png", { width=424, height=367, numFrames=1,sheetContentWidth=424,sheetContentHeight=367 } )
		map56sheeto2=graphics.newImageSheet( "notgoh/carte/level14/ag.png", { width=179, height=1113, numFrames=1,sheetContentWidth=179,sheetContentHeight=1113 } )
		map56sheeto3=graphics.newImageSheet( "notgoh/carte/level14/am1.png", { width=1816, height=228, numFrames=1,sheetContentWidth=1816,sheetContentHeight=228 } )
		map56sheeto4=graphics.newImageSheet( "notgoh/carte/level14/ad.png", { width=214, height=1186, numFrames=1,sheetContentWidth=214,sheetContentHeight=1186 } )
		map56sheeto5=graphics.newImageSheet( "notgoh/carte/level14/am2.png", { width=1595, height=419, numFrames=1,sheetContentWidth=1595,sheetContentHeight=419 } )
		map56sheeto6=graphics.newImageSheet( "notgoh/carte/level14/m1.png", { width=288, height=557, numFrames=1,sheetContentWidth=288,sheetContentHeight=557 } )
		map56sheeto7=graphics.newImageSheet( "notgoh/carte/level14/m2.png", { width=159, height=156, numFrames=1,sheetContentWidth=159,sheetContentHeight=156 } )
		map56sheeto8=graphics.newImageSheet( "notgoh/carte/level14/m3.png", { width=285, height=194, numFrames=1,sheetContentWidth=285,sheetContentHeight=194 } )
		map56sheeto9=graphics.newImageSheet( "notgoh/carte/level14/m4.png", { width=243, height=178, numFrames=1,sheetContentWidth=243,sheetContentHeight=178 } )
		map56sheeto10=graphics.newImageSheet( "notgoh/carte/level14/m5.png", { width=59, height=21, numFrames=1,sheetContentWidth=59,sheetContentHeight=21 } )
		map56sheeto11=graphics.newImageSheet( "notgoh/carte/level14/m6.png", { width=351, height=383, numFrames=1,sheetContentWidth=351,sheetContentHeight=383 } )
		map56sheeto12=graphics.newImageSheet( "notgoh/carte/level14/m7.png", { width=278, height=183, numFrames=1,sheetContentWidth=278,sheetContentHeight=183 } )
	
	end
		
	hg=display.newImage(map56sheethg,1) --display.newImage( "carte/level2/hg.png", -1024,-512,true )
	hg.x=-1024
	hg.y=-512
	hd=display.newImage(map56sheethd,1) --display.newImage( "carte/level2/hd.png",1024,-512,true )
	hd.x=1024
	hd.y=-512
	bg=display.newImage(map56sheetbg,1) --display.newImage( "carte/level2/bg.png", -1024,512,true )
	bg.x=-1024
	bg.y=512
	bd=display.newImage(map56sheetbd,1) --display.newImage( "carte/level2/bd.png", 1024,512,true )
	bd.x=1024
	bd.y=512
