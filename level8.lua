...
t.affichagecarte=function(pole)	
	if donneecharger[48]==0 then
		donneecharger[48]=1
		map8sheethg=graphics.newImageSheet( "notgoh/carte/level8/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map8sheethd=graphics.newImageSheet( "notgoh/carte/level8/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map8sheetbg=graphics.newImageSheet( "notgoh/carte/level8/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map8sheetbd=graphics.newImageSheet( "notgoh/carte/level8/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map8sheeto1=graphics.newImageSheet( "notgoh/carte/level8/1.png", { width=559, height=689, numFrames=1,sheetContentWidth=559,sheetContentHeight=689 } )
		map8sheeto2=graphics.newImageSheet( "notgoh/carte/level8/2.png", { width=2048, height=295, numFrames=1,sheetContentWidth=2048,sheetContentHeight=295 } )
		map8sheeto3=graphics.newImageSheet( "notgoh/carte/level8/3.png", { width=1325, height=299, numFrames=1,sheetContentWidth=1325,sheetContentHeight=299 } )
		map8sheeto4=graphics.newImageSheet( "notgoh/carte/level8/4.png", { width=107, height=531, numFrames=1,sheetContentWidth=107,sheetContentHeight=531 } )
