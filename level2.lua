...
t.affichagecarte=function(pole)
	if donneecharger[42]==0 then
		donneecharger[42]=1
		map2sheethg=graphics.newImageSheet( "notgoh/carte/level2/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map2sheethd=graphics.newImageSheet( "notgoh/carte/level2/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map2sheetbg=graphics.newImageSheet( "notgoh/carte/level2/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map2sheetbd=graphics.newImageSheet( "notgoh/carte/level2/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map2sheetobd1=graphics.newImageSheet( "notgoh/carte/level2/map1p1.png", { width=1400, height=910, numFrames=1,sheetContentWidth=1400,sheetContentHeight=910 } )
		map2sheetobd2=graphics.newImageSheet( "notgoh/carte/level2/map1p2.png", { width=1409, height=401, numFrames=1,sheetContentWidth=1409,sheetContentHeight=401 } )
		map2sheetomid=graphics.newImageSheet( "notgoh/carte/level2/obstacle1.png", { width=337, height=298, numFrames=1,sheetContentWidth=337,sheetContentHeight=298 } )
