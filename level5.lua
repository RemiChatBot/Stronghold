...
t.affichagecarte=function(pole)
	if donneecharger[45]==0 then
		donneecharger[45]=1
		map5sheethg=graphics.newImageSheet( "notgoh/carte/level5/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map5sheethd=graphics.newImageSheet( "notgoh/carte/level5/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map5sheetbg=graphics.newImageSheet( "notgoh/carte/level5/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map5sheetbd=graphics.newImageSheet( "notgoh/carte/level5/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map5sheeto1=graphics.newImageSheet( "notgoh/carte/level5/1.png", { width=872, height=2048, numFrames=1,sheetContentWidth=872,sheetContentHeight=2048 } )
		map5sheeto2=graphics.newImageSheet( "notgoh/carte/level5/2.png", { width=678, height=873, numFrames=1,sheetContentWidth=678,sheetContentHeight=873 } )
		map5sheeto3=graphics.newImageSheet( "notgoh/carte/level5/3.png", { width=333, height=565, numFrames=1,sheetContentWidth=333,sheetContentHeight=565 } )
		map5sheeto4=graphics.newImageSheet( "notgoh/carte/level5/4.png", { width=474, height=273, numFrames=1,sheetContentWidth=474,sheetContentHeight=273 } )
		map5sheeto5=graphics.newImageSheet( "notgoh/carte/level5/5.png", { width=1700, height=117, numFrames=1,sheetContentWidth=1700,sheetContentHeight=117 } )
		map5sheeto6=graphics.newImageSheet( "notgoh/carte/level5/6.png", { width=576, height=186, numFrames=1,sheetContentWidth=576,sheetContentHeight=186 } )
