...
t.affichagecarte=function(pole)
	if donneecharger[53]==0 then
		donneecharger[53]=1
		map13sheethg=graphics.newImageSheet( "notgoh/carte/level13/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map13sheethd=graphics.newImageSheet( "notgoh/carte/level13/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map13sheetbg=graphics.newImageSheet( "notgoh/carte/level13/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map13sheetbd=graphics.newImageSheet( "notgoh/carte/level13/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map13sheeto1=graphics.newImageSheet( "notgoh/carte/level13/1.png", { width=189, height=175, numFrames=1,sheetContentWidth=189,sheetContentHeight=175 } )
	end
