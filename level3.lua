...
t.affichagecarte=function(pole)
	if donneecharger[43]==0 then
		donneecharger[43]=1
		map3sheethg=graphics.newImageSheet( "notgoh/carte/level3/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map3sheethd=graphics.newImageSheet( "notgoh/carte/level3/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map3sheetbg=graphics.newImageSheet( "notgoh/carte/level3/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map3sheetbd=graphics.newImageSheet( "notgoh/carte/level3/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map3sheeto1=graphics.newImageSheet( "notgoh/carte/level3/g.png", { width=269, height=910, numFrames=1,sheetContentWidth=269,sheetContentHeight=910 } )
		map3sheeto2=graphics.newImageSheet( "notgoh/carte/level3/hg1.png", { width=148, height=192, numFrames=1,sheetContentWidth=148,sheetContentHeight=192 } )
		map3sheeto3=graphics.newImageSheet( "notgoh/carte/level3/pont.png", { width=459, height=277, numFrames=1,sheetContentWidth=459,sheetContentHeight=277 } )
