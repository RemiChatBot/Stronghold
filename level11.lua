...
t.affichagecarte=function(pole)	
	if donneecharger[51]==0 then
		donneecharger[51]=1
		map11sheethg=graphics.newImageSheet( "notgoh/carte/level11/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map11sheethd=graphics.newImageSheet( "notgoh/carte/level11/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map11sheetbg=graphics.newImageSheet( "notgoh/carte/level11/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map11sheetbd=graphics.newImageSheet( "notgoh/carte/level11/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map11sheeto1=graphics.newImageSheet( "notgoh/carte/level11/1.png", { width=1200, height=861, numFrames=1,sheetContentWidth=1200,sheetContentHeight=861 } )
		map11sheeto2=graphics.newImageSheet( "notgoh/carte/level11/2.png", { width=2028, height=224, numFrames=1,sheetContentWidth=2028,sheetContentHeight=224 } )
		map11sheeto3=graphics.newImageSheet( "notgoh/carte/level11/3.png", { width=454, height=475, numFrames=1,sheetContentWidth=454,sheetContentHeight=475 } )
		map11sheeto4=graphics.newImageSheet( "notgoh/carte/level11/4.png", { width=247, height=261, numFrames=1,sheetContentWidth=247,sheetContentHeight=261 } )
		if desert==nil then
