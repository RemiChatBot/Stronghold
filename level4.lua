...
t.affichagecarte=function(pole)
	if donneecharger[44]==0 then
		donneecharger[44]=1
		map4sheethg=graphics.newImageSheet( "notgoh/carte/level4/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map4sheethd=graphics.newImageSheet( "notgoh/carte/level4/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map4sheetbg=graphics.newImageSheet( "notgoh/carte/level4/bg.jpg", { width=2048, height=1024, numFrames=1 ,sheetContentWidth=2048,sheetContentHeight=1024} )
		map4sheetbd=graphics.newImageSheet( "notgoh/carte/level4/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map4sheeto1=graphics.newImageSheet( "notgoh/carte/level4/bg.png", { width=1709, height=891, numFrames=1,sheetContentWidth=1709,sheetContentHeight=891 } )
		map4sheeto2=graphics.newImageSheet( "notgoh/carte/level4/bm.png", { width=2000, height=228, numFrames=1,sheetContentWidth=2000,sheetContentHeight=228 } )
		map4sheeto3=graphics.newImageSheet( "notgoh/carte/level4/c.png", { width=217, height=377, numFrames=1,sheetContentWidth=217,sheetContentHeight=377 } )
		map4sheeto4=graphics.newImageSheet( "notgoh/carte/level4/g.png", { width=286, height=722, numFrames=1,sheetContentWidth=286,sheetContentHeight=722 } )
		map4sheeto5=graphics.newImageSheet( "notgoh/carte/level4/ani.png", { width=500, height=499, numFrames=1,sheetContentWidth=500,sheetContentHeight=499 } )
