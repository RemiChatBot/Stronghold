...
t.affichagecarte=function(pole)
	if donneecharger[46]==0 then
		donneecharger[46]=1
		map6sheethg=graphics.newImageSheet( "notgoh/carte/level6/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map6sheethd=graphics.newImageSheet( "notgoh/carte/level6/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map6sheetbg=graphics.newImageSheet( "notgoh/carte/level6/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map6sheetbd=graphics.newImageSheet( "notgoh/carte/level6/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map6sheeto1=graphics.newImageSheet( "notgoh/carte/level6/e.png",  { width=346, height=358, numFrames=1,sheetContentWidth=346,sheetContentHeight=358 } )
		map6sheeto2=graphics.newImageSheet( "notgoh/carte/level6/ca.png", { width=206, height=266, numFrames=1,sheetContentWidth=206,sheetContentHeight=266 } )
		map6sheeto3=graphics.newImageSheet( "notgoh/carte/level6/m.png",  { width=185, height=174, numFrames=1,sheetContentWidth=185,sheetContentHeight=174 } )
		map6sheeto4=graphics.newImageSheet( "notgoh/carte/level6/hd.png", { width=415, height=476, numFrames=1,sheetContentWidth=415,sheetContentHeight=476 } )
		map6sheeto5=graphics.newImageSheet( "notgoh/carte/level6/bm.png", { width=1446, height=269, numFrames=1,sheetContentWidth=1446,sheetContentHeight=269 } )
		map6sheeto6=graphics.newImageSheet( "notgoh/carte/level6/bg.png", { width=961, height=143, numFrames=1,sheetContentWidth=961,sheetContentHeight=143 } )
		if lapinanim==nil then
			lapinanim=graphics.newImageSheet("notgoh/carte/level5/lapin.png", { width=80, height=55, numFrames=7 } )
			lapinanimseq =
			{
			    name="liq",
