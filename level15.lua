...
t.affichagecarte=function(pole)
	if donneecharger[55]==0 then
		donneecharger[55]=1
		map55sheethg=graphics.newImageSheet( "notgoh/carte/level15/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map55sheethd=graphics.newImageSheet( "notgoh/carte/level15/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map55sheetbg=graphics.newImageSheet( "notgoh/carte/level15/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map55sheetbd=graphics.newImageSheet( "notgoh/carte/level15/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map55sheeto1=graphics.newImageSheet( "notgoh/carte/level15/1.png", { width=1633, height=356, numFrames=1,sheetContentWidth=1633,sheetContentHeight=356 } )
		map55sheeto2=graphics.newImageSheet( "notgoh/carte/level15/2.png", { width=331, height=383, numFrames=1,sheetContentWidth=331,sheetContentHeight=383 } )
		map55sheeto3=graphics.newImageSheet( "notgoh/carte/level15/3.png", { width=315, height=280, numFrames=1,sheetContentWidth=315,sheetContentHeight=280 } )
		map55sheeto4=graphics.newImageSheet( "notgoh/carte/level15/4.png", { width=203, height=280, numFrames=1,sheetContentWidth=203,sheetContentHeight=280 } )
		map55sheeto5=graphics.newImageSheet( "notgoh/carte/level15/5.png", { width=175, height=386, numFrames=1,sheetContentWidth=175,sheetContentHeight=386 } )
		map55sheeto6=graphics.newImageSheet( "notgoh/carte/level15/6.png", { width=778, height=416, numFrames=1,sheetContentWidth=778,sheetContentHeight=416 } )
		map55sheeto7=graphics.newImageSheet( "notgoh/carte/level15/7.png", { width=175, height=431, numFrames=1,sheetContentWidth=175,sheetContentHeight=431 } )
		map55sheeto8=graphics.newImageSheet( "notgoh/carte/level15/8.png", { width=597, height=209, numFrames=1,sheetContentWidth=597,sheetContentHeight=209 } )
		map55sheeto9=graphics.newImageSheet( "notgoh/carte/level15/9.png", { width=571, height=444, numFrames=1,sheetContentWidth=571,sheetContentHeight=444 } )
		map55sheeto10=graphics.newImageSheet( "notgoh/carte/level15/10.png", { width=203, height=280, numFrames=1,sheetContentWidth=203,sheetContentHeight=280 } )
		map55sheeto11=graphics.newImageSheet( "notgoh/carte/level15/11.png", { width=554, height=533, numFrames=1,sheetContentWidth=554,sheetContentHeight=533 } )
		map55sheeto12=graphics.newImageSheet( "notgoh/carte/level15/12.png", { width=251, height=293, numFrames=1,sheetContentWidth=251,sheetContentHeight=293 } )
		map55sheeto13=graphics.newImageSheet( "notgoh/carte/level15/13.png", { width=892, height=304, numFrames=1,sheetContentWidth=892,sheetContentHeight=304 } )
		map55sheeto14=graphics.newImageSheet( "notgoh/carte/level15/14.png", { width=1290, height=557, numFrames=1,sheetContentWidth=1290,sheetContentHeight=557 } )
		map55sheeto15=graphics.newImageSheet( "notgoh/carte/level15/15.png", { width=614, height=419, numFrames=1,sheetContentWidth=614,sheetContentHeight=419 } )
	end
		
	hg=display.newImage(map55sheethg,1) --display.newImage( "carte/level2/hg.png", -1024,-512,true )
	hg.x=-1024
	hg.y=-512
	hd=display.newImage(map55sheethd,1) --display.newImage( "carte/level2/hd.png",1024,-512,true )
	hd.x=1024
	hd.y=-512
