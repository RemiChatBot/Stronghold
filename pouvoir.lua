...
if pouvoirdisp>0 then
	...
	pouvoir1.x=xminscreen+200*0.2*0.5*apparence+20--actualcontentwidth+(xminscreen)-200*0.1
	pouvoir1.y=contentcentery+0.5*actualcontentheight-200*0.2*0.5*apparence-20
