...
t.affichagecarte=function(pole)
	if donneecharger[54]==0 then
		donneecharger[54]=1
		map14sheethg=graphics.newImageSheet( "notgoh/carte/level14/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map14sheethd=graphics.newImageSheet( "notgoh/carte/level14/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map14sheetbg=graphics.newImageSheet( "notgoh/carte/level14/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map14sheetbd=graphics.newImageSheet( "notgoh/carte/level14/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map14sheeto1=graphics.newImageSheet( "notgoh/carte/level14/ah.png", { width=424, height=367, numFrames=1,sheetContentWidth=424,sheetContentHeight=367 } )
		map14sheeto2=graphics.newImageSheet( "notgoh/carte/level14/ag.png", { width=179, height=1113, numFrames=1,sheetContentWidth=179,sheetContentHeight=1113 } )
		map14sheeto3=graphics.newImageSheet( "notgoh/carte/level14/am1.png", { width=1816, height=228, numFrames=1,sheetContentWidth=1816,sheetContentHeight=228 } )
		map14sheeto4=graphics.newImageSheet( "notgoh/carte/level14/ad.png", { width=214, height=1186, numFrames=1,sheetContentWidth=214,sheetContentHeight=1186 } )
		map14sheeto5=graphics.newImageSheet( "notgoh/carte/level14/am2.png", { width=1595, height=419, numFrames=1,sheetContentWidth=1595,sheetContentHeight=419 } )
		map14sheeto6=graphics.newImageSheet( "notgoh/carte/level14/m1.png", { width=288, height=557, numFrames=1,sheetContentWidth=288,sheetContentHeight=557 } )
		map14sheeto7=graphics.newImageSheet( "notgoh/carte/level14/m2.png", { width=159, height=156, numFrames=1,sheetContentWidth=159,sheetContentHeight=156 } )
		map14sheeto8=graphics.newImageSheet( "notgoh/carte/level14/m3.png", { width=285, height=194, numFrames=1,sheetContentWidth=285,sheetContentHeight=194 } )
		map14sheeto9=graphics.newImageSheet( "notgoh/carte/level14/m4.png", { width=243, height=178, numFrames=1,sheetContentWidth=243,sheetContentHeight=178 } )
		map14sheeto10=graphics.newImageSheet( "notgoh/carte/level14/m5.png", { width=59, height=21, numFrames=1,sheetContentWidth=59,sheetContentHeight=21 } )
		map14sheeto11=graphics.newImageSheet( "notgoh/carte/level14/m6.png", { width=351, height=383, numFrames=1,sheetContentWidth=351,sheetContentHeight=383 } )
		map14sheeto12=graphics.newImageSheet( "notgoh/carte/level14/m7.png", { width=278, height=183, numFrames=1,sheetContentWidth=278,sheetContentHeight=183 } )
