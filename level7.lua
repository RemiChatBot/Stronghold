...
t.affichagecarte=function(pole)
	if donneecharger[47]==0 then
		donneecharger[47]=1
		map7sheethg=graphics.newImageSheet( "notgoh/carte/level7/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map7sheethd=graphics.newImageSheet( "notgoh/carte/level7/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map7sheetbg=graphics.newImageSheet( "notgoh/carte/level7/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map7sheetbd=graphics.newImageSheet( "notgoh/carte/level7/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map7sheeto1=graphics.newImageSheet( "notgoh/carte/level7/bg1.png", { width=407, height=851, numFrames=1,sheetContentWidth=407,sheetContentHeight=851 } )
		map7sheeto2=graphics.newImageSheet( "notgoh/carte/level7/bg2.png", { width=1100, height=201, numFrames=1,sheetContentWidth=1100,sheetContentHeight=201 } )
