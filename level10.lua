...
t.affichagecarte=function(pole)	
	if donneecharger[50]==0 then
		donneecharger[50]=1
		map10sheethg=graphics.newImageSheet( "notgoh/carte/level10/hg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map10sheethd=graphics.newImageSheet( "notgoh/carte/level10/hd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map10sheetbg=graphics.newImageSheet( "notgoh/carte/level10/bg.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map10sheetbd=graphics.newImageSheet( "notgoh/carte/level10/bd.jpg", { width=2048, height=1024, numFrames=1,sheetContentWidth=2048,sheetContentHeight=1024 } )
		map10sheeto1=graphics.newImageSheet( "notgoh/carte/level10/1.png", { width=795, height=228, numFrames=1,sheetContentWidth=795,sheetContentHeight=228 } )
		map10sheeto2=graphics.newImageSheet( "notgoh/carte/level10/2.png", { width=493, height=1251, numFrames=1,sheetContentWidth=493,sheetContentHeight=1251 } )
		map10sheeto3=graphics.newImageSheet( "notgoh/carte/level10/3.png", { width=632, height=192, numFrames=1,sheetContentWidth=632,sheetContentHeight=192 } )
		map10sheeto4=graphics.newImageSheet( "notgoh/carte/level10/4.png", { width=87, height=156, numFrames=1,sheetContentWidth=87,sheetContentHeight=156 } )
		map10sheeto5=graphics.newImageSheet( "notgoh/carte/level10/5.png", { width=159, height=247, numFrames=1,sheetContentWidth=159,sheetContentHeight=247 } )
		map10sheeto6=graphics.newImageSheet( "notgoh/carte/level10/6.png", { width=206, height=247, numFrames=1,sheetContentWidth=206,sheetContentHeight=247 } )
		map10sheeto7=graphics.newImageSheet( "notgoh/carte/level10/7.png", { width=189, height=254, numFrames=1,sheetContentWidth=189,sheetContentHeight=254 } )
		map10sheeto8=graphics.newImageSheet( "notgoh/carte/level10/8.png", { width=343, height=362, numFrames=1,sheetContentWidth=343,sheetContentHeight=362 } )
		map10sheeto9=graphics.newImageSheet( "notgoh/carte/level10/9.png", { width=2002, height=319, numFrames=1,sheetContentWidth=2002,sheetContentHeight=319 } )
		if desert==nil then
